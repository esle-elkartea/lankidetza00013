 ...
 *
 */
public abstract class BasePartesPeer
    extends BasePeer
{
    ...
    {
        return getMapBuilder(PartesMapBuilder.CLASS_NAME);
    }

      /** the column name for the IDPARTE field */
    public static final String IDPARTE;
    ...
    static
    {
          ...
          IDUEJECUCION = "partes.IDUEJECUCION";
          IDOPERARIO = "partes.IDOPERARIO";
          IDMAQUINARIA = "partes.IDMAQUINARIA";
          FECHA = "partes.FECHA";
          REFERENCIA = "partes.REFERENCIA";
          DESCRIPCION = "partes.DESCRIPCION";
          OBSERVACIONES = "partes.OBSERVACIONES";
          HORAS = "partes.HORAS";
          IMPORTE = "partes.IMPORTE";
          if (Torque.isInit())
        {
            try
            {
                getMapBuilder(PartesMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(PartesMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "net.idtoki.aveobras.model.Partes";
    ...
    public static void addSelectColumns(Criteria criteria)
            throws TorqueException
    {
          criteria.addSelectColumn(IDPARTE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Partes row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Partes obj = (Partes) cls.newInstance();
            PartesPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setIdparte(row.getValue(offset + 0).asInt());
                  ...
                  obj.setFecha(row.getValue(offset + 4).asString());
                  obj.setReferencia(row.getValue(offset + 5).asString());
                  obj.setDescripcion(row.getValue(offset + 6).asString());
                  obj.setObservaciones(row.getValue(offset + 7).asString());
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            Record row = (Record) records.get(i);
              results.add(PartesPeer.row2Object(row, 1,
                PartesPeer.getOMClass()));
          }
        return results;
    }
        ...
        throws TorqueException
    {
        Criteria selectCriteria = new Criteria(DATABASE_NAME, 2);
                   selectCriteria.put(IDPARTE, criteria.remove(IDPARTE));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(Partes obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Partes obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Partes obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Partes obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Partes) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Partes obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Partes) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Partes obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Partes) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Partes obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ObjectKey pk )
    {
        Criteria criteria = new Criteria();
              criteria.add(IDPARTE, pk);
          return criteria;
     }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( Partes obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(IDPARTE, obj.getIdparte());
    ...
    public static Criteria buildSelectCriteria( Partes obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
                    criteria.add(IDPARTE, obj.getIdparte());
     ...
     */
    public static Partes retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Partes retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Partes retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Partes retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Partes retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
    ...
    /**
     * selects a collection of Partes objects pre-filled with their
     * Maquinarias objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PartesPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
        ...
        throws TorqueException
    {
        ...
        PartesPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        MaquinariasPeer.addSelectColumns(criteria);


                        criteria.addJoin(PartesPeer.IDMAQUINARIA,
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            Record row = (Record) rows.get(i);
                            ...
                            Class omClass = PartesPeer.getOMClass();
                    Partes obj1 = (Partes) PartesPeer
            ...
            {
                Partes temp_obj1 = (Partes)results.get(j);
        ...
        throws TorqueException
    {
        ...
        OperariosPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(PartesPeer.IDOPERARIO,
        ...
        throws TorqueException
    {
        ...
        UejecucionesPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(PartesPeer.IDUEJECUCION,
    ...
    /**
     * selects a collection of Partes objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
        ...
        throws TorqueException
    {
        ...
        int offset3 = offset2 + OperariosPeer.numColumns;
                    ...
                    UejecucionesPeer.addSelectColumns(criteria);
        int offset4 = offset3 + UejecucionesPeer.numColumns;
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                           ...
                           omClass = UejecucionesPeer.getOMClass();
                          Uejecuciones obj3 = (Uejecuciones)UejecucionesPeer
            ...
            {
                Partes temp_obj1 = (Partes)results.get(j);
                Uejecuciones temp_obj3 = (Uejecuciones)temp_obj1.getUejecuciones();
