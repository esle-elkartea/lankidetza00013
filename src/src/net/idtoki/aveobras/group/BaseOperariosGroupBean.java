 ...
 *
 */
public abstract class BaseOperariosGroupBean
    extends BaseGroupBean
{

    /** el logger para esta clase */
    private static final Logger logger = Logger
			.getLogger("net.idtoki.aveobras.BaseOperariosGroup");
	...
	public void setOperarioss(Criteria criteria, boolean paginado) {
		this.setElementos(criteria, paginado);
	}

	public Operarios getOperarios() {
		return (Operarios) getNext();
	}

	public Operarios getOperarios(int posicion) {
		return (Operarios) get(posicion);
	}
