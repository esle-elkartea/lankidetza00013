 ...
 */
public class IncidenciasGroupBean
    extends net.idtoki.aveobras.group.BaseIncidenciasGroupBean
{
  public IncidenciasGroupBean(){
        this.dbField = IncidenciasPeer.IDINCIDENCIA;
