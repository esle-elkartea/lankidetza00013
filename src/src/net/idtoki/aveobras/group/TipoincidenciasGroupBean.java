 ...
 */
public class TipoincidenciasGroupBean
    extends net.idtoki.aveobras.group.BaseTipoincidenciasGroupBean
{
  public TipoincidenciasGroupBean(){
        this.dbField = TipoincidenciasPeer.IDTIPOINCIDENCIA;
