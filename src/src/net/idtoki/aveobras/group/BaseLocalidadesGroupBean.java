 ...
 *
 */
public abstract class BaseLocalidadesGroupBean
    extends BaseGroupBean
{

    /** el logger para esta clase */
    private static final Logger logger = Logger
			.getLogger("net.idtoki.aveobras.BaseLocalidadesGroup");
	...
	public void setLocalidadess(Criteria criteria, boolean paginado) {
		this.setElementos(criteria, paginado);
	}

	public Localidades getLocalidades() {
		return (Localidades) getNext();
	}

	public Localidades getLocalidades(int posicion) {
	...
	public List abstractSelect(Criteria c) throws TorqueException {
		return LocalidadesPeer.doSelect(c);
	}

	public List abstractVillageRecords(Criteria c) throws TorqueException {
		return LocalidadesPeer.doSelectVillageRecords(c);
	}

	public void abstractSave(Connection conn) throws TorqueException {
		Localidades element = null;
		while (this.next()) {
			element = this.getLocalidades();
			element.save(conn);
		}
	}
