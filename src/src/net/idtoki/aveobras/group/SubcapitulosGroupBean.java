 ...
 */
public class SubcapitulosGroupBean
    extends net.idtoki.aveobras.group.BaseSubcapitulosGroupBean
{
  public SubcapitulosGroupBean(){
        this.dbField = SubcapitulosPeer.IDSUBCAPITULO;
