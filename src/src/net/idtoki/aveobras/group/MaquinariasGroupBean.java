 ...
 */
public class MaquinariasGroupBean
    extends net.idtoki.aveobras.group.BaseMaquinariasGroupBean
{
  public MaquinariasGroupBean(){
        this.dbField = MaquinariasPeer.IDMAQUINARIA;
