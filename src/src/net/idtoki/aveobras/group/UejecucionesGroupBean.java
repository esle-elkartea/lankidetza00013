 ...
 */
public class UejecucionesGroupBean
    extends net.idtoki.aveobras.group.BaseUejecucionesGroupBean
{
  public UejecucionesGroupBean(){
        this.dbField = UejecucionesPeer.IDUEJECUCION;
