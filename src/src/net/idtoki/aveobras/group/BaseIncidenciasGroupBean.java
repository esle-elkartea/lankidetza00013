 ...
 *
 */
public abstract class BaseIncidenciasGroupBean
    extends BaseGroupBean
{

    /** el logger para esta clase */
    private static final Logger logger = Logger
			.getLogger("net.idtoki.aveobras.BaseIncidenciasGroup");
	...
	public void setIncidenciass(Criteria criteria, boolean paginado) {
		this.setElementos(criteria, paginado);
	}

	public Incidencias getIncidencias() {
		return (Incidencias) getNext();
	}

	public Incidencias getIncidencias(int posicion) {
		return (Incidencias) get(posicion);
	}
	...
	public List abstractSelect(Criteria c) throws TorqueException {
		return IncidenciasPeer.doSelect(c);
	}

	public List abstractVillageRecords(Criteria c) throws TorqueException {
		return IncidenciasPeer.doSelectVillageRecords(c);
	}

	public void abstractSave(Connection conn) throws TorqueException {
		Incidencias element = null;
		while (this.next()) {
			element = this.getIncidencias();
			element.save(conn);
		}
	}
